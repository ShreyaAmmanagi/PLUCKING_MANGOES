...
function setup() {
	...
	mango5 = new object(770, 290, 50, 50);
	mango6 = new object(800, 300, 50, 50)
...
function collided2(obj1,obj2){
	if(obj1.body.position.x-obj2.body.position.x<=obj1.width/2+obj2.width/2){
          return true;
	}
